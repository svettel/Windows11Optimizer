...
업데이트(2026-06-29): 시각효과 관련 설정을 세분화하였습니다. 전원 옵션은 터보주파수옵션에 대한 테스트가 완료될 때 까지 윈도우에서 기본 지원하는 '최고의 성능' 항목만 지원합니다.  

업데이트(2026-06-26): 최적화 후 파일탐색기가 새로 뜨는 현상을 제거하였습니다. 최적화 후 반드시 재부팅을 권장합니다.    

업데이트(2026-06-18): 검색 기능 최적화 항목을 세분화 하였습니다. 터미널과 명령 프롬프트가 같이 뜨는 현상을 개선하였습니다.  
...
- 일반PC권장설정
- 게임PC 반응성 최대화
- CPU자원최대사용(CPU/GPU 벤치마크용,권장하지않음)
